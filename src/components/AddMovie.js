      ...
      <section class="text-gray-400 body-font relative">
        <div class="container px-24 py-12 mx-auto">
          <div class="flex flex-col text-center w-full mb-4">
            <h1 class="sm:text-3xl text-xl font-medium title-font mb-4 text-blue-300">Add Movie</h1>
              ...
              <div class="p-2 w-1/2">
                <div class="relative">
                  ...
                  <input
                    ...
                    class="w-full rounded border border-gray-700
                   focus:border-indigo-500  focus:ring-2  text-base outline-none text-gray-700
              ...
              <div class="p-2 w-full">
                <div class="relative">
                  ...
                  <textarea
                   ...
                   border-gray-700 h-32 text-base outline-none text-gray-700  focus:border-indigo-500
                     focus:ring-2  py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
                </div>
              </div>
              <div class="p-2 w-full">
